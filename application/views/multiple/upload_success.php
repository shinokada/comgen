...
if(isset($allinone))
{
    echo form_hidden('allinone', $allinone);
}

if(isset($mycommentarea))
{
    echo form_hidden('mycommentarea', $mycommentarea);
}
...
foreach($row1 as $key=>$value )
{
    //echo $key."<br />";
    if($key>1)
    {// this will skip [0] => Section:2(A) Math 6,
        ...
        if(!empty($list[0]))
        {// if a family name exists, since Powerschool produce empty arrays
            if($list[2]=="M")
            {// find out gender
                $namecolor="boy";
                $pronoun=" He";
            ...
            if(isset($showibgrade) AND $showibgrade==="1")
            {
                ...
                for ($r=1; $r<8; $r++)
                {
                    ...
                    $gradecomment=$this->lang->line($grade);
                    $gradecomment = sprintf($gradecomment, $thestudent, $pronoun, $pronoun, $pronoun, $pronoun, $pronoun, $pronoun, $pronoun);
                    echo "<div class=\"comment\">".form_radio($radio).$gradecomment."</div>\n";
                    echo "</td>\n";
                }
                echo "</tr>\n";
                echo "</table>\n";        
            ...
            if(isset($lacomment) AND $lacomment==="1")
            {
                ...
                //echo "<tr>";
                for ($r=1; $r<5; $r++)
                {//$r stands for row number. Collaboration needs 4 columns.
                    echo "<tr>\n";
                    for ($c=1; $c < 6; $c++) 
                    {// 5th column for none to unselect other 
                ...
                echo "<tr><th width=\"20%\"><h3>Poor</h3></th><th width=\"20%\"><h3>Basic</h3></th><th width=\"20%\"><h3>Proficient</h3></th><th width=\"20%\"><h3>Advanced</h3></th><th width=\"20%\"><h3>None</h3></th></tr>\n";
                for ($r=1; $r<5; $r++)
                {//$r stands for row number. Independence needs 4 rows.
                    echo "<tr>\n";
                    for ($c=1; $c < 6; $c++) 
                    {
                ...
                echo "<tr><th width=\"20%\"><h3>Poor</h3></th><th width=\"20%\"><h3>Basic</h3></th><th width=\"20%\"><h3>Proficient</h3></th><th width=\"20%\"><h3>Advanced</h3></th><th width=\"20%\"><h3>None</h3></th></tr>\n";
                for ($r=1; $r<4; $r++)
                {//$r stands for row number Organizational needs only 3 rows
                    echo "<tr>\n";
                    for ($c=1; $c < 6; $c++) 
                    {// need 4 columns
            ...
            // start mycommentarea
            if(isset($mycommentarea) AND $mycommentarea==="1")
            {
                $data = array(
                    'name'           => 'mycommentarea'."_$key",
                    'class'          => 'mycommentarea',
                    'value'          => '',
                    'rows'           => '5',
                    'cols'           => '50',
